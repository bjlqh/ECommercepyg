    ...
    <div id="item">
        <div class="crumb-wrap">
            <ul class="sui-breadcrumb">
                <li>
                    <a href="#">${good.categoryName.category1Name}</a>
                </li>
                <li>
                    <a href="#">${good.categoryName.category2Name}</a>
                </li>
                <li>
                    <a href="#">${good.categoryName.category3Name}</a>
                </li>
        ...
        <div class="product-info">
            <div class="fl preview-wrap">
                <!--放大镜效果-->
            <#--[
            {"color":"黑色","url":"http://192.168.25.133/group1/M00/00/00/wKgZhVvqyMOAWft2AAB7gLYr3bM482.jpg"},
            {"color":"土豪金","url":"http://192.168.25.133/group1/M00/00/00/wKgZhVvqyM6AVQBJAACAc8YVcJ4878.jpg"},
            {"color":"银色","url":"http://192.168.25.133/group1/M00/00/00/wKgZhVvqyN6AZDTcAACB4v6TfCE294.jpg"}
            ]-->
            <#assign imageList=good.goodsDesc.itemImages?eval/>
                <div class="zoom">
                    <#if (imageList?size>0)>
                    <!--默认第一个预览-->
                    <div id="preview" class="spec-preview">
                        <span class="jqzoom"><img jqimg="${imageList[0].url}" src="${imageList[0].url}" width="300px"
                                                  height="400"/></span>
                    </div>
                    </#if>
                    <!--下方的缩略图-->
            ...
            <div class="fr itemInfo-wrap">
                ...
                <div class="clearfix choose">
                    <div id="specification" class="summary-wrap clearfix">
                            <#assign specList=good.goodsDesc.specificationItems?eval/>

                    <#--[
                        {"attributeValue":["移动4G","联通4G"],"attributeName":"网络"},
                        {"attributeValue":["64G","128G","32G"],"attributeName":"机身内存"}
                        ]-->
                        ...
                        <dl>
                            <dt>
                                ...
                                <dd>
                                    <a href="javascript:" ng-click="selectSpec('${spec.attributeName}','${value}')" class="{{isSelected('${spec.attributeName}','${value}')?'selected':''}}">${value}<span title="点击取消选择">&nbsp;</span></a>
                                </dd>
                                </#list>
                        </dl>
                        </#list>
